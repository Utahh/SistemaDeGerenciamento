...
require_once("_script/FuncionarioDAO.php");
require_once("_script/CategoriaDAO.php");
    ...
    if( !isset($_SESSION["nome_funcionario_logado"]) )
    	header('Location: index.php?ERRO=2');


    /* Pega variável de página "page"
     * Não deixa o funcionario normal acessar aquelas páginas que só admin podem */
    if( isset($_GET["page"]) ){
        if( $_SESSION["permissao_funcionario_logado"] == 1 )
            $menu = $_GET["page"];
        elseif( ($_SESSION["permissao_funcionario_logado"] == 0) && ($_GET["page"] != "FuncionarioCadastrar") )
                $menu = $_GET["page"];
}
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="funcionario_listagem.php"><i class="glyphicon glyphicon-asterisk"></i>&nbsp;&nbsp; Alterar Senha</a></li>
                        <li class="divider"></li>
        ...
        <div class="col-sm-3" id="sideBar">
            ...
            <ul class="nav nav-stacked">
                ...
                <li class="nav-header"><a href="#" data-toggle="collapse" data-target="#menuCompras">
                    ...
                    <ul class="nav nav-stacked collapse" id="menuEntrada">
                            <li><a href="#"><i class="glyphicon glyphicon-plus-sign"></i> Registrar Entrada</a></li>
                            <li><a href="#"><i class="glyphicon glyphicon-list-alt"></i> Histórico de Entrada</a></li>
                    </ul>
            ...
            <ul class="nav nav-stacked">
                ...
                <li class="nav-header"><a href="#" data-toggle="collapse" data-target="#menuProdutos">
                    ...
                    <?php } ?>
                        ...
                        <ul class="nav nav-stacked collapse <?php if(isset($menuAberto)){echo $menuAberto; $menuAberto = '';}?>" id="menuProdutos">
                            ...
                            <?php if( $_SESSION['permissao_funcionario_logado'] == 1 ){  ?>
                ...
                <li class="nav-header"><a href="#" data-toggle="collapse" data-target="#menuUsuario">
                    ...
                    <?php if( ($menu=='FuncionarioConsultar') || ($menu=='FuncionarioCadastrar') ){ ?>
                        <i class="glyphicon glyphicon-chevron-up"></i></a> <?php
                        $menuAberto = "in";
                    }else{ ?>
                        <i class="glyphicon glyphicon-chevron-down"></i></a>
                    <?php } ?>
                        ...
                        <ul class="nav nav-stacked collapse <?php if(isset($menuAberto)){echo $menuAberto; $menuAberto = '';}?>" id="menuUsuario">
                            ...
                            <!-- Só mostra link de Cadastrar se o usuário for Admin -->
                            <?php if( $_SESSION['permissao_funcionario_logado'] == 1 ){  ?>
                                <li><a href="?page=FuncionarioCadastrar"><i class="glyphicon glyphicon-cog"></i> Cadastrar</a></li>
                            <?php } ?>
                    </ul>
                </li>
            </ul>
           ...
           <?php
                switch ($menu)
                {
                    case "ProdutosCategorias":
                        ...
                        break;
                    case "FuncionarioConsultar":
                        include('_paginas/funcionario_listagem.php');
                        break;
                    case "FuncionarioCadastrar":
                        include('_paginas/funcionario_cadastrar.php');
                        break;
                    default:
